...
* **Microsoft Store Readiness**: Replaced the legacy installer with a fully compliant MSIX package (`FreeRangeExamSuite_3.6.0.0.msix`), ensuring seamless installation, secure sandboxing, and direct validation through the [Microsoft Store](https://apps.microsoft.com/detail/9NSKJD6DV0KL?hl=it&gl=IT&ocid=pdpshare).
